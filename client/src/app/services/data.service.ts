...
export class DataService {
  ...
  public baseURLCOVID =
    "https://devlp.solveninja.org/wp-includes/covid/rest-api";
  ...
  getCampaigns(obj) {
    return this.httpClient.get(
      `${this.baseURL}/neighbourHood/getCampaigns.php`,
      { headers: this.headers }
    );
  }
  getAgencies(obj) {
    return this.httpClient.post(
      `${this.baseURL}/Agency/GetCivicAgencies.php`,
      obj,
      { headers: this.headers }
    );
  }
  getGovernance(obj) {
    return this.httpClient.post(
      `${this.baseURL}/Governance/GetGovernanceData.php`,
      obj,
      { headers: this.headers }
    );
  }
  getDWCC(obj) {
    return this.httpClient.post(`${this.baseURL}/DWCC/GetDWCCData.php`, obj, {
      headers: this.headers,
    });
  }
  getToilets(obj) {
    return this.httpClient.post(
      `${this.baseURL}/Toilets/GetToiletsData.php`,
      obj,
      { headers: this.headers }
    );
  }
  getReports(obj) {
    return this.httpClient.post(
      `${this.baseURL}/neighbourHood/getReports.php`,
      obj,
      { headers: this.headers }
    );
  }
  compareReport(obj) {
    return this.httpClient.post(
      `${this.baseURL}/neighbourHood/compareReports.php`,
      obj,
      { headers: this.headers }
    );
  }
  AQMdata(obj) {
    return this.httpClient.post(`${this.baseURL}/AQM/GetAqmValues.php`, obj, {
      headers: this.headers,
    });
  }
  AQMDataStn(obj) {
    return this.httpClient.post(
      `${this.baseURL}/AQM/GetAqmDataForStation.php`,
      obj,
      { headers: this.headers }
    );
  }
  getCorrLocWard(obj) {
    return this.httpClient.post(`${this.baseURL}/getWardName.php`, obj, {
      headers: this.headers,
    });
  }
  getCorrLocDetails(obj) {
    return this.httpClient.post(`${this.baseURLCOVID}/getDetailData.php`, obj, {
      headers: this.headers,
    });
  ...
  getDashboardData(obj) {
    return this.httpClient.post(
      `${this.baseURLCOVID}/neighbourHood/getDetailData.php`,
      obj,
      { headers: this.headers }
    );
  }
  ...
  getMenuList(obj) {
    return this.httpClient.post(
      `${this.baseURLCOVID}/neighbourHood/getMenuItems.php`,
      obj,
      { headers: this.headers }
    );
  }
  ...
  CollectionsDataES(obj) {
    ...
    if (this.orgname != "All" && this.orgname != "") {
      params["creatorOrg"] = this.orgname;
    }
   ...
   */
  getUserInfo() {
    return this.httpClient.get(`/api/v1/user/data/read`, {
      headers: this.headers,
    });
  }
   ...
   */
  getOrgsList() {
    return this.httpClient.get(`${this.baseEsSolv}/creators`, {
      headers: this.headers,
    });
  }
  ...
  getUserAssignedList(obj) {
    return this.httpClient.post(`/getassignedlist`, obj, {
      headers: this.headers,
    });
  }
  ...
  getAllassignedList(obj) {
    return this.httpClient.post(`/getAllassignedList`, obj, {
      headers: this.headers,
    });
  }
  ...
  GettotalClosedAsignmentUser(obj) {
    return this.httpClient.post(`/getTotalClosedUser`, obj, {
      headers: this.headers,
    });
  }
  ...
  CollectionsData(obj) {
    return this.httpClient.post(
      `${this.baseURLCOVID}/neighbourHood/controller.php`,
      obj,
      { headers: this.headers }
    );
  }
  cityDetails() {
    return this.httpClient.post(`${this.baseURL}/neighbourHood/getCities.php`, {
      headers: this.headers,
    });
  }
  wardDetails(obj) {
    return this.httpClient.post(
      `${this.baseURL}/neighbourHood/getWards.php`,
      obj,
      { headers: this.headers }
    );
  }
  ichangemycity(lat, lan) {
    return this.httpClient.get(
      `https://www.ichangemycity.com/map/get_ward?latitude=${lat}&longitude=${lan}`,
      { headers: this.headers }
    );
  }
}
