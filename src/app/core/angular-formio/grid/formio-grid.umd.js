(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@angular/router'), require('rxjs'), require('formiojs'), require('lodash'), require('formiojs/utils/Evaluator'), require('@angular/elements'), require('ngx-bootstrap/pagination')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', '@angular/router', 'rxjs', 'formiojs', 'lodash', 'formiojs/utils/Evaluator', '@angular/elements', 'ngx-bootstrap/pagination'], factory) :
    (global = global || self, factory(global['formio-grid'] = {}, global.core, global.common, global.forms, global.router, global.rxjs, global.formiojs, global.lodash, global.Evaluator, global.elements, global.pagination));
}(this, (function (exports, core, common, forms, router, rxjs, formiojs, lodash, Evaluator, elements, pagination) { 'use strict';
    ...
    var SubmissionGridHeaderComponent = /** @class */ (function (_super) {
        ...
        function (column, component, sort) {
            ...
            this.headers.push({
                ...
                key: key,
                sort: sort || '',
                component: component ? formiojs.Components.create(component, null, null, true) : null,
    ...
    var formatDate = formiojs.Utils.formatDate;
